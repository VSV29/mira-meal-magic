  ...
  return (
    <div className="mobile-container bg-cream min-h-screen pb-24">
      ...
      <div className="mx-4 mt-4 rounded-xl p-4"
        ...
        <p className="text-[13px] text-cream">{needToBuy.filter(i => i.online).length} urgent items can be ordered from BigBasket by Friday — {formatBudget(onlineTotal, userCountry)} total</p>
